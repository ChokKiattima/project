    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/ac/7e/b0/ac7eb0b97a4b554491efd82ba5aa2bf3.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กมะพร้าว - coconut Cake</h1>
                <p class="product-description">
                    เค้กมะพร้าว คือลุคที่นุ่มละมุนและหอมหวานแบบธรรมชาติ ใครที่ชอบรสชาติหอมมันจากมะพร้าว ต้องโดน! เค้กมะพร้าวคือการรวมตัวของความอร่อยและความฟินที่ลงตัวมาก
                </p>
