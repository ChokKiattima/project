    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://png.pngtree.com/png-clipart/20231124/original/pngtree-orange-cake-white-picture-image_13281529.png">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กส้ม - Orange Cake Piece</h1>
                <p class="product-description">
                    เค้กส้มเป็นเค้กเนื้อนุ่ม หอมกลิ่นส้ม รสหวานอมเปรี้ยว สอดไส้และเคลือบด้วยซอสส้มสดชื่น เพิ่มความอร่อยด้วยเนื้อส้มตกแต่งด้านบน
                </p>
