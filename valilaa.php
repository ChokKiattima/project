    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://bakerbynature.com/wp-content/uploads/2022/04/Golden-Vanilla-Cake-with-Vanilla-Frosting0-30.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กวนิลา - Vanilla Cake Piece</h1>
                <p class="product-description">
                    เค้กวนิลลาเป็นเค้กเนื้อนุ่ม หอมกลิ่นวนิลลา รสหวานละมุน มักเสิร์ฟคู่กับครีม วิปครีม หรือผลไม้ เพิ่มความอร่อยกลมกล่อม
                </p>
