    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://www.rainbownourishments.com/wp-content/uploads/2022/02/vegan-strawberry-cake-3.jpg">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กสตอเบอร์รี่ - Strawberry Cake Piece</h1>
                <p class="product-description">
                    เค้กสตรอเบอร์รี่เป็นเค้กเนื้อนุ่ม หวานละมุน สอดไส้และตกแต่งด้วยสตรอเบอร์รี่สด วิปครีม หรือซอสสตรอเบอร์รี่ ให้รสหวานอมเปรี้ยวสดชื่น
                </p>
                
                <div class="product-price">160 บาท</div>
