    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/0d/ed/ba/0dedba3896d160768acc364d082926ce.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กส้ม - Orange Cake</h1>
                <p class="product-description">
                    เค้กส้ม คือเค้กที่ไม่มีดราม่า! อร่อยง่าย สดชื่น หวานอมเปรี้ยวแบบลงตัว กินแล้วเหมือนโดนปลุกพลังชีวิต! 🍊✨ ถ้าใครเบื่อเค้กหวาน ๆ เลี่ยน ๆ เค้กส้มคือตัวตึงที่ต้องลอง
                </p>
                
                <div class="product-price">300 บาท</div>
