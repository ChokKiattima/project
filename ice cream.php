    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://image.makewebcdn.com/makeweb/m_1200x600/jKZC6GmS7/other/31.png    " alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กไอติมช็อกโกแลต - Chocolate Ice Cream</h1>
                <p class="product-description">
                    เค้กช็อกโกแลตเนื้อนุ่ม ผสานไอศกรีมช็อกโกแลตเข้มข้น ละมุนด้วยวิปครีมหอมมัน ตกแต่งด้วยช็อกโกแลตชิพและซอสช็อกโกแลตเยิ้มๆ ฟินทุกคำ สายช็อกโกแลตต้องลอง!
                </p>
                
                <div class="product-price">400 บาท</div>
