    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/de/c3/54/dec3547435d522d794358e88e86602ba.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">Black Forest cake</h1>
                <p class="product-description">
                    เค้กนี้มีรสหวานของครีม ผสมกับรสเข้มของช็อกโกแลตและความเปรี้ยวของเชอร์รี่ ทำให้เป็นเค้กยอดนิยมทั่วโลก เหมาะสำหรับงานเฉลิมฉลองหรือโอกาสพิเศษ 
                </p>
                
                <div class="product-price">500 บาท</div>
