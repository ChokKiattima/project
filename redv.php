    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/15/89/bc/1589bc3e846d7e8ad3c69645ad80ea39.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">Red Velvet Cake</h1>
                <p class="product-description">
                    เค้กช็อกโกแลตเป็นหนึ่งในเค้กที่ได้รับความนิยมมากที่สุด ด้วยรสชาติที่เข้มข้น หอมละมุน และความนุ่มของเนื้อเค้กที่ละลายในปาก เหมาะกับทั้งคนรักของหวานและสายช็อกโกแลตโดยเฉพาะ
                </p>
