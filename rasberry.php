<?php 
 session_start(); // เริ่มต้น session เพื่อใช้ $_SESSION
    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/e3/33/0f/e3330f4c813af17ec6936ae2f57d726e.jpg">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">ทาร์ตรสชาติราสเบอร์รี่ - RASBERRY TART</h1>
                <p class="product-description">
                    ราสเบอร์รี่ทาร์ตเป็นขนมหวานที่ผสมผสานความกรุบกรอบของแป้งทาร์ตเนยสดเข้ากับรสชาติเปรี้ยวหวานของราสเบอร์รี่สด ตัดกันอย่างลงตัวด้วยครีมคัสตาร์ดเนียนนุ่ม หรือบางสูตรอาจใช้ครีมอัลมอนด์ (Frangipane) เพิ่มความหอมมัน เมื่อกัดเข้าไปจะสัมผัสได้ถึงความสดชื่นของผลไม้ ผสานกับกลิ่นหอมของเนยและวานิลลา ทำให้เป็นเมนูที่เหมาะทั้งทานเล่น หรือเสิร์ฟคู่กับชาร้อนและกาแฟ
                </p>
                
                <div class="product-price">60 บาท</div>
