    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/fd/b3/21/fdb321c04921a71fb02a40145857345c.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กเรดเวลเวท - Red Velvet Cake Piece</h1>
                <p class="product-description">
                    เค้กเรดเวลเวทเป็นเค้กเนื้อนุ่มสีแดงเข้ม รสละมุน หวานกำลังดี ตัดกับครีมชีสฟรอสติ้งหอมมัน ให้รสชาติกลมกล่อมและหรูหรา
                </p>
