    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiNRzxyqIjubdtMgo7NLoMm19lPqs__jEaaw&s">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กแบล็คฟอเรส - BlackForest Cake Piece</h1>
                <p class="product-description">
                    เค้กแบล็กฟอเรสต์เป็นเค้กช็อกโกแลตเนื้อนุ่ม สอดไส้และตกแต่งด้วยเชอร์รี่ ไซรัปเชอร์รี่ และวิปครีม โรยหน้าด้วยช็อกโกแลตขูด ให้รสหวานขมและเปรี้ยวสดชื่นลงตัว
