    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/ea/ab/53/eaab53fa631bfbaffc42e81fcc55e620.jpg">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">บรู๊คกี้ - BROOKIE</h1>
                <p class="product-description">
                    ขนมลูกครึ่งระหว่างบราวนี่และคุกกี้ รวมความเข้มข้นของบราวนี่กับเนื้อสัมผัสกรอบนอกนุ่มในของคุกกี้ ทำให้ได้รสชาติที่ทั้งหนึบหนับและกรุบกรอบในคำเดียวกัน
                </p>
