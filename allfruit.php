    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/99/8f/c0/998fc0772a1ccca2a3af3b25b26cdf84.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กผลไม้รวม - Mix fruit Cake</h1>
                <p class="product-description">
                    เค้กผลไม้รวม ก็คือเค้กที่ให้ฟีลสดชื่นกว่าถูกรักแบบไม่ต้องพยายาม!  มีทั้งความหอมหวานของเนื้อเค้ก ตัดกับรสเปรี้ยวอมหวานของผลไม้แต่ละชนิด กินแล้วสดชื่นเว่อร์
                </p>
