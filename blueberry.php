...
<head>
    ...
    <link rel="stylesheet" href="bluberry.css">
    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/86/df/cb/86dfcb89446c7694b57eae6371986a01.jpg" alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กบลูเบอร์รี่ - Blueberry Cake Pound</h1>
                <p class="product-description">
                    เค้กบลูเบอร์รี่เป็นของหวานที่ได้รับความนิยม เพราะรสชาติหอมหวาน เปรี้ยวอมหวานของบลูเบอร์รี่เข้ากันได้ดีกับเนื้อเค้กนุ่ม ๆ และครีมเนียน ๆ
                </p>
                
                <div class="product-price">650 บาท</div>
