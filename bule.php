    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://simplyhomecooked.com/wp-content/uploads/2017/05/Berry-chantilly-cake-22.jpg">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กบลูเบอร์รี่ - Blueberry Cake Piece</h1>
                <p class="product-description">
                    เค้กบลูเบอร์รี่เป็นเค้กเนื้อนุ่ม รสหวานอมเปรี้ยวจากบลูเบอร์รี่สดหรือแยม มักมีการเติมครีม หรือฟรอสติ้งเพื่อเพิ่มความอร่อย เหมาะทานเป็นของหวานในงานเลี้ยงหรือกับชาและกาแฟ
                </p>
                
                <div class="product-price">130 บาท</div>
