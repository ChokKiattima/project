    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://image.makewebcdn.com/makeweb/m_1920x0/jKZC6GmS7/other/34.png?v=202405291424   " alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กไอติมสตรอว์เบอร์รี่ - Strawberry Ice Cream</h1>
                <p class="product-description">
                    เค้กเนื้อนุ่ม ผสานกับไอศกรีมสตรอว์เบอร์รีเข้มข้น ตกแต่งด้วยสตรอว์เบอร์รีสดฉ่ำๆ และวิปครีมหอมมัน ให้รสชาติเปรี้ยวอมหวาน สดชื่นสุดๆ! เหมาะสำหรับทุกโอกาส ลองแล้วจะหลงรัก!
                </p>
                
                <div class="product-price">600 บาท</div>
