    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://www.stephiecooks.com/wp-content/uploads/2013/05/close-up-coconut-cake-slice.webp">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กมะพร้าว - Coconut Cake Piece</h1>
                <p class="product-description">
                    เค้กมะพร้าวเป็นเค้กเนื้อนุ่ม หอมหวาน สอดไส้และตกแต่งด้วยครีมหรือเนื้อมะพร้าวอ่อน ให้รสชาติละมุนและสดชื่น
                </p>
