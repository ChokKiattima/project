    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://img.wongnai.com/p/400x0/2019/08/10/1b388707e24a42228efcb4a7cd29a94a.jpg    " alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กไอติมโอริโอ้ - Orio Ice Cream</h1>
                <p class="product-description">
                    เค้กโอริโอ้เนื้อนุ่ม ผสานไอศกรีม เค้กโอริโอ้แลตเข้มข้น ละมุนด้วยวิปครีมหอมมัน ตกแต่งด้วยช็อกโกแลตชิพและซอสช็อกโกแลตเยิ้มๆ ฟินทุกคำ สายช็อกโกแลตต้องลอง!
                </p>
