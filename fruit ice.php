    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://image.makewebcdn.com/makeweb/m_1920x0/jKZC6GmS7/other/32.png?v=202405291424   " alt="Blueberry Cake Piece">
                
            </div>
            
            <div class="product-details">
                <h1 class="product-title">เค้กไอติมผลไม้รวม - Mixed Fruit Ice Cream</h1>
                <p class="product-description">
                    เค้กเนื้อนุ่มผสมผสานกับไอศกรีมผลไม้รวมหลากหลายชนิด ทั้งสตรอว์เบอร์รี, มะม่วง, และกีวี ให้รสชาติหวานเปรี้ยวสดชื่น ตกแต่งด้วยผลไม้สด เพิ่มความอร่อยแบบธรรมชาติในทุกคำ!
                </p>
                
                <div class="product-price">350 บาท</div>
