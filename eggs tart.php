    ...
    <div class="container">
        <div class="product-container">
            <div class="product-image">
                <img src="https://i.pinimg.com/736x/a1/7b/1c/a17b1c88d73adc3abf04cc55e54aa6c1.jpg">
            </div>
            
            <div class="product-details">
                <h1 class="product-title">ทาร์ตไข่ - EGG TART</h1>
                <p class="product-description">
                    ขนมหวานยอดนิยมที่มีรสชาติกลมกล่อม เปลือกทาร์ตกรอบนอกนุ่มใน และไส้ไข่ที่เนียนนุ่มหวานหอม เมื่อกัดไปจะได้สัมผัสความอ่อนโยนของไข่พุดดิ้งที่ผสมผสานกับความกรอบของแป้งทาร์ตอย่างลงตัว นอกจากนี้ทาร์ตไข่มักมีสีเหลืองทองสวยงามจากไข่แดงที่ใช้ในกระบวนการทำทาร์ต ทำให้ดูน่ากินและอร่อยยิ่งขึ้น
                </p>
                
                <div class="product-price">20 บาท</div>
